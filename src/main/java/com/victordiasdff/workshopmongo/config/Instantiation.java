...
import com.victordiasdff.workshopmongo.dto.AuthorDTO;
import com.victordiasdff.workshopmongo.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null, sdf.parse("21/03/2018"), "Partiu viagem", "Vou viajar para SP, até!", new AuthorDTO (maria));
